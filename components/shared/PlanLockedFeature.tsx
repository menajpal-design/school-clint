  ...
  return (
    <Card className={cn("overflow-hidden border-amber-200 bg-amber-50/60 shadow-sm", fullPage && "min-h-[58vh]", className)}>
      <CardContent className={cn("relative p-0", fullPage && "min-h-[58vh]")}>
        <div className="pointer-events-none select-none p-5 blur-[2px] opacity-45">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-white/60 p-4 backdrop-blur-[1px]">
          <div className="max-w-lg rounded-2xl border border-amber-200 bg-white p-6 text-center shadow-lg">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              {description ||
                "এই অংশটি দেখতে এবং ব্যবহার করতে paid subscription active করতে হবে। Free Lifetime প্যাকেজে এই ফিচার চালু থাকবে না।"}
            </p>
