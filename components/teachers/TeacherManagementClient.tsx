...
type TeacherForm = { name: string; email: string; phone: string; employeeId: string; role: TeacherRole; classTeacherClassId: string; designation: string; department: string; assignedClasses: string[]; subjects: string[]; salary: string; joiningDate: string; qualification: string; experience: string; autoIdCard: boolean; sendAppointmentLetter: boolean };

const emptyForm: TeacherForm = { name: '', email: '', phone: '', employeeId: '', role: 'subject_teacher', classTeacherClassId: '', designation: 'Teacher', department: '', assignedClasses: [], subjects: [], salary: '', joiningDate: new Date().toISOString().slice(0, 10), qualification: '', experience: '0', autoIdCard: true, sendAppointmentLetter: false };
