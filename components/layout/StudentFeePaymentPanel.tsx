...
export function StudentFeePaymentPanel() {
  ...
  const load = async () => {
    ...
    try { setData(await apiClient.get("/finance/my-fees", { skipToast: true })); }
    ...
    <section className="mb-5 rounded-xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-emerald-800">মাসিক ও অন্যান্য ফি এখান থেকে দেখা যাবে। School online payment setting চালু থাকলে student/parent online payment করতে পারবে। Teacher/office offline টাকা জমা দিলে সেটিও Payment History-তে যুক্ত হবে।</p>
        </div>
