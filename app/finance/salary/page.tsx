...
export default function SalaryPage() {
  ...
  return <div className="space-y-5">
    <PageHeader title="Salary Processing" description="Process teacher and staff salaries and generate slips." icon={Landmark} />
