  ...
  return (
    <RoleGuard roles={["head"]} fallback={<div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">Salary information is visible to the Head only.</div>}>
      <div className="space-y-5">
        ...
        <section className="overflow-hidden rounded-lg border border-border bg-card shadow-sm"><Table><TableHeader><TableRow className="bg-muted hover:bg-muted"><TableHead>Employee</TableHead><TableHead>Type</TableHead><TableHead>Attendance Days</TableHead><TableHead>Basic</TableHead><TableHead>Deduction</TableHead><TableHead>Bonus</TableHead><TableHead>Net</TableHead><TableHead>Actions</TableHead></TableRow></TableHeader><TableBody>
