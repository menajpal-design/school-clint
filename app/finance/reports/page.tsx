...
export default function FinanceReportsPage() {
  ...
  const openQrVerify = () => window.open('/verify/fee-receipt', '_blank', 'noopener,noreferrer');
  ...
  return <div className="space-y-5">
    ...
    <div ref={reportRef} className="space-y-5 bg-card">
      ...
      <ClassCollectionTable rows={classWiseRows} loading={loading} onDownloadReceipt={downloadReceipt} onVerifyReceipt={verifyReceipt} printingId={printingId} />
...
function ClassCollectionTable({ rows, loading, onDownloadReceipt, onVerifyReceipt, printingId }: { rows: any[]; loading: boolean; onDownloadReceipt: (row: any) => void; onVerifyReceipt: (row: any) => void; printingId: string }) {
  ...
  const detailRows = selectedClass?.collections || [];
