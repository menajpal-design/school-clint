...
type StaffForm = { name: string; email: string; phone: string; department: string; salary: string; joiningDate: string; photo: string; autoIdCard: boolean };

const emptyForm: StaffForm = { name: '', email: '', phone: '', department: 'General', salary: '', joiningDate: new Date().toISOString().slice(0, 10), photo: '', autoIdCard: true };
