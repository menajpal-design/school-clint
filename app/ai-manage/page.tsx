...
const cqQuestions = (count: number, subject: string, syllabus: string): QuestionItem[] => Array.from({ length: Math.max(1, Math.min(60, count || 8)) }).map((_, index) => ({ type: 'cq', question: `${index + 1}. ${subject || 'Subject'} - ${syllabus || 'à¦¸à¦¿à¦²à§‡à¦¬à¦¾à¦¸'} à¦¥à§‡à¦•à§‡ à¦ à¦•à¦Ÿà¦¿ à¦¸à§ƒà¦œà¦¨à¦¶à§€à¦²/CQ à¦ªà§ à¦°à¦¶à§ à¦¨ à¦¤à§ˆà¦°à¦¿ à¦•à¦°à§ à¦¨\nà¦•) à¦œà§ à¦žà¦¾à¦¨à¦®à§‚à¦²à¦• à¦ªà§ à¦°à¦¶à§ à¦¨\nà¦–) à¦…à¦¨à§ à¦§à¦¾à¦¬à¦¨à¦®à§‚à¦²à¦• à¦ªà§ à¦°à¦¶à§ à¦¨\nà¦—) à¦ªà§ à¦°à§Ÿà§‹à¦—à¦®à§‚à¦²à¦• à¦ªà§ à¦°à¦¶à§ à¦¨\nà¦˜) à¦‰à¦šà§ à¦šà¦¤à¦° à¦¦à¦•à§ à¦·à¦¤à¦¾à¦®à§‚à¦²à¦• à¦ªà§ à¦°à¦¶à§ à¦¨`, options: [], answer: 'Teacher verification required', marks: 10 }));
  ...
  if (isFree) {
    return (
      <div className="p-4 md:p-6">
        <PlanLockedFeature
          title="Question Generate এবং AI Manage লক করা আছে"
          description="Syllabus অনুযায়ী এআই দিয়ে প্রশ্নপত্র তৈরি ও সেভ করার ফিচার ব্যবহার করতে দয়া করে সাবস্ক্রিপশন আপডেট করুন।"
          featureName="AI Question Generator"
          fullPage
        />
      </div>
    );
