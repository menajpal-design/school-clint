    ...
    <main className="min-h-screen bg-slate-50 flex flex-col items-center py-10 px-4 font-sans text-slate-800">
      <div className="w-full max-w-5xl space-y-6">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-5">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="text-xs font-bold text-slate-600 hover:text-slate-900 transition flex items-center gap-1.5 hover:underline">
              <ArrowLeft className="h-3.5 w-3.5" />
              Back to Portal
            </Link>
            <Button asChild variant="outline" className="border-slate-350 text-slate-700 hover:bg-slate-50 font-bold rounded-xl shadow-sm text-xs px-4">
