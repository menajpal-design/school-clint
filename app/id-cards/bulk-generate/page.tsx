...
export default function BulkGeneratePage() {
  ...
  const downloadZip = () => {
    ...
    const a = document.createElement("a"); a.href = URL.createObjectURL(blob); a.download = "generated-id-cards.zip.json"; a.click();
  };

  return <div className="space-y-5">
    <PageHeader title="Bulk ID Card Generate" description="Filter people, select up to 50 and generate cards in a batch." icon={Users} actions={[{ label: "Download ZIP", icon: Download, onClick: downloadZip }]} />
