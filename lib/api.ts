...
export const api: any = {
  ...
  attendance: {
    ...
    getStudentAttendance: (studentId: string) => apiClient.get(`/attendance/student/${String(studentId).replace(/^(student:|user:|teacher:|staff:|user-|student-)/g, '')}`),
    getPersonAttendance: (type: 'teacher' | 'staff', id: string) => apiClient.get(`/attendance/person/${type}/${String(id).replace(/^(student:|user:|teacher:|staff:|user-|student-)/g, '')}`),
